...
public class VideoDewasaExoFragment extends VideoFragment{
    ...
    Uri uri = RawResourceDataSource.buildRawResourceUri(R.raw.dewasa1);
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (intentMetaData != null) {
            ...
            mMediaPlayerGlue.setTitle("Kemampuan Bersosialisasi");
            mMediaPlayerGlue.setSubtitle("Dewasa");
