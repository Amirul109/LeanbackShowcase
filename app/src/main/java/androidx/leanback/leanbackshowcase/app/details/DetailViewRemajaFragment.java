...
public class DetailViewRemajaFragment extends DetailsFragment implements OnItemViewClickedListener,
        OnItemViewSelectedListener{
    public static final String TRANSITION_NAME = "t_for_transition";
    public static final String EXTRA_CARD = "card";

    private static final long ACTION_BUY = 1;
    private static final long ACTION_WISHLIST = 4;
    ...
    private void setupUi() {
        ...
        String json = Utils
                .inputStreamToString(getResources().openRawResource(R.raw.remaja_detail));
